...
#ratings: List or dictionary containing the overall scores of each category in the survey
...
#ratings: List or dictionary containing the local scores (each line) of each category in the survey
